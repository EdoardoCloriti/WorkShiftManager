...
/**
 * Receiver per le notifiche prima dell'inizio del turno
 *
 * @Author edoardo.cloriti@studio.unibo.it
 */
public class WorkshiftManagerNotifyReciver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        NotificationCompat.Builder mBuilder =
                new NotificationCompat.Builder(context)
                        .setSmallIcon(R.mipmap.ic_history_black_48dp)
                        .setContentTitle("WorkShift Manager")
                        .setContentText("Il tuo turno sta per cominciare!")
                        .setAutoCancel(true)
                        .setDefaults(-1);
